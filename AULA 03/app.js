/*****************************************************************
 * Objetivo: Criar um sistema que permite o calculo de juro 
 * utilizando bas práticas com funções
 * Autor: Anderson
 * Data: 11/02/2026
 * Versão: 1.0
 *****************************************************************/
...
entradaDeDados.question('Digite o nome do cliente:', function(nome){
    ...
    entradaDeDados.question('Digite o nome do Produto:', function(produto){
        ...
        entradaDeDados.question('Digite  valor da compra:', function(capital){
